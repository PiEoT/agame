...
public class HttpEngine {
        ...
        public static byte[] __doPost(Context ctx, String posturl, final byte[] buffer) {
        ...
        public static byte[] doGet(Context ctx, String url) {
                ...
                try {
                        ...
                        v2 = new byte[1024];
                        int length = 0;
                        while ((length = v8.read(v2)) > 0) {
                                v1.write(v2, 0, length);
                        }
                        v1.flush();
                        v1.close();
                        v8.close();
